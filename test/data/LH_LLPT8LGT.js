export default {
    ...
    text: `Lufthansa (LH) LLPT8LGT FRA to NYC
General notes
LOW/OFF-PEAK SEASON ECONOMY RT UNBUNDLED  L
FARES
...
Category 4: Flight restrictions
  THE FARE COMPONENT MUST BE ON
      ONE OR MORE OF THE FOLLOWING
        ...
        ANY LH FLIGHT OPERATED BY AC
        ANY LH FLIGHT OPERATED BY SN
        ANY LH FLIGHT OPERATED BY 4Y
        ANY 4Y FLIGHT OPERATED BY 4Y.
...
Category 5: Advanced reservation/ticketing restrictions
  ...
  AFTER RESERVATIONS ARE MADE OR AT LEAST 14 DAYS BEFORE
  DEPARTURE WHICHEVER IS EARLIER.
  OR - RESERVATIONS FOR ALL SECTORS ARE REQUIRED AT LEAST 14
       DAYS BEFORE DEPARTURE.
       TICKETING MUST BE COMPLETED WITHIN 48 HOURS AFTER
...
Category 10: Combinability
  ...
  OPEN JAWS
   ...
   PROVIDED -
     ...
     COMBINATIONS ARE WITH ANY ECONOMY RT UNBUNDLED-TYPE
     FARES FOR CARRIER LH/UA/AC/OS/LX/SN/4Y IN ANY RULE AND
     TARIFF.
...
Category 15: Sales restrictions
  ...
  SALE IS RESTRICTED TO SPECIFIC AGENTS.
  SALE IS RESTRICTED TO SPECIFIC AGENTS.
  FARES MAY ONLY BE SOLD BY LH OR UA.
    ...
    ANY TIME
      CHANGES PERMITTED.
         NOTE -
          ...
          ONLY -LGT TYPE FARE INTO -LGT/-BV/-LQ TYPE FARE.
          -----------------------------------------------
          REROUTING PERMITTED.
          -----------------------------------------------
          WAIVERS MUST BE EVIDENCED BY DEATH CERTIFICATE.
   ...
   BEFORE DEPARTURE OF JOURNEY - APPLIES WITHIN TKT VALIDITY
    ...
    THOSE OF LH INTERNATIONAL FARES
     ...
     W/O SEAT AND
      ...
      LX/MS/NH/NZ/OS/OU/OZ/SA/SK/SN/SQ/TG/TK/TP/UA/ZH L-LGT
       FARE FAMILY IS USED
      ...
      REPRICE USING FARES IN EFFECT WHEN TKT WAS ISSUED
       ...
       2. CHANGE IS BEFORE ORIGINAL SCHEDULED FLIGHT
       3. 4Y/A3/AC/AI/AV/BR/CA/CM/EN/ET/EW/HO/IN/JP/LH/LO/
      LX/MS/NH/NZ/OS/OU/OZ/SA/SK/SN/SQ/TG/TK/TP/UA/ZH -LGT
       FARE FAMILY IS USED
       4. PUBLIC FARES ARE USED IF TICKETED FARE IS IN
       PUBLIC TARIFF. PRIVATE FARES ARE USED IF TICKETED
       FARE IS IN PRIVATE TARIFF
      ...
      REPRICE USING FARES IN EFFECT WHEN TKT WAS ISSUED
       ...
       2. CHANGE IS BEFORE ORIGINAL SCHEDULED FLIGHT
       3. 4Y/A3/AC/AI/AV/BR/CA/CM/EN/ET/EW/HO/IN/JP/LH/LO/
      LX/MS/NH/NZ/OS/OU/OZ/SA/SK/SN/SQ/TG/TK/TP/UA/ZH L-LQ
       FARE FAMILY IS USED
       4. PUBLIC FARES ARE USED IF TICKETED FARE IS IN
       PUBLIC TARIFF. PRIVATE FARES ARE USED IF TICKETED
       FARE IS IN PRIVATE TARIFF
      ...
      REPRICE USING FARES IN EFFECT WHEN TKT WAS ISSUED
       ...
       2. CHANGE IS BEFORE ORIGINAL SCHEDULED FLIGHT
       3. 4Y/A3/AC/AI/AV/BR/CA/CM/EN/ET/EW/HO/IN/JP/LH/LO/
      LX/MS/NH/NZ/OS/OU/OZ/SA/SK/SN/SQ/TG/TK/TP/UA/ZH -LQ
       FARE FAMILY IS USED
       4. PUBLIC FARES ARE USED IF TICKETED FARE IS IN
       PUBLIC TARIFF. PRIVATE FARES ARE USED IF TICKETED
       FARE IS IN PRIVATE TARIFF
      ...
      REPRICE USING FARES IN EFFECT WHEN TKT WAS ISSUED
       ...
       2. CHANGE IS BEFORE ORIGINAL SCHEDULED FLIGHT
       3. 4Y/A3/AC/AI/AV/BR/CA/CM/EN/ET/EW/HO/IN/JP/LH/LO/
      LX/MS/NH/NZ/OS/OU/OZ/SA/SK/SN/SQ/TG/TK/TP/UA/ZH L-BV
       FARE FAMILY IS USED
       4. PUBLIC FARES ARE USED IF TICKETED FARE IS IN
       PUBLIC TARIFF. PRIVATE FARES ARE USED IF TICKETED
       FARE IS IN PRIVATE TARIFF
      ...
      REPRICE USING FARES IN EFFECT WHEN TKT WAS ISSUED
       ...
       2. CHANGE IS BEFORE ORIGINAL SCHEDULED FLIGHT
       3. 4Y/A3/AC/AI/AV/BR/CA/CM/EN/ET/EW/HO/IN/JP/LH/LO/
      LX/MS/NH/NZ/OS/OU/OZ/SA/SK/SN/SQ/TG/TK/TP/UA/ZH -BV
       FARE FAMILY IS USED
       4. PUBLIC FARES ARE USED IF TICKETED FARE IS IN
       PUBLIC TARIFF. PRIVATE FARES ARE USED IF TICKETED
       FARE IS IN PRIVATE TARIFF
